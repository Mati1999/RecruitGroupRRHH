...
const ServiciosPage = () => {
  ...
  const evaluacionesLaborales = [
    ...
    },
    {
      ...
      descripcion:
        "El proceso psicodiagnóstico va más allá de las habilidades técnicas, consta de un proceso donde nos adentramos profundamente en la personalidad del candidato, evaluando la salud mental y emocional del mismo a través de entrevistas clínicas y cuestionarios psicológicos estandarizados. Este proceso proporciona un análisis profundo de la personalidad, el estado emocional y la posible presencia de trastornos psicológicos que puedan afectar el rendimiento, las relaciones laborales o la estabilidad del candidato. También, nos permite ver su capacidad de razonamiento lógico e intelectual, lo que es un gran factor al momento de resolver problemáticas y tomar decisiones. Por otro lado, también se evalúa su capacidad de liderazgo, lo cual es esencial en trabajadores que ocuparán mandos gerenciales o directivos. Permite prever riesgos potenciales, asegurar la selección de personas emocionalmente equilibradas y mejorar el clima laboral. Además, incluye un enfoque personalizado que evalúa el ajuste a la cultura organizacional, promoviendo equipos cohesionados y un entorno laboral saludable.",
